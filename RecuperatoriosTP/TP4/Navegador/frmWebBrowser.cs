...
namespace Navegador
{
    public delegate void DescargaCallBack(int prog);
    ...
    public partial class frmWebBrowser : Form
    {
        ...
        private void btnIr_Click(object sender, EventArgs e)
        {
            ...
            descargador.ProgresoDelEvento += new ProgresoDelEvento(ProgresoDescarga);
            descargador.FinDelEvento += new FinDelEvento(FinDescarga);
