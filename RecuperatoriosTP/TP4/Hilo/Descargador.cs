...
namespace Hilo
{
    public delegate void ProgresoDelEvento(int prog);
    public delegate void FinDelEvento(string html);
    public class Descargador
    {
        private string html;
        private Uri direccion;
        public event ProgresoDelEvento ProgresoDelEvento;
        public event FinDelEvento FinDelEvento;
